...
namespace DMP\PaginatorBundle\Pagination\ArgumentResolver;

use DMP\PaginatorBundle\Pagination\ArgumentResolver\Exception\PaginationArgumentValueResolverTypeNotSupporting;
