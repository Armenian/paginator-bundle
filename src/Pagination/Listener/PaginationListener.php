...
namespace DMP\PaginatorBundle\Pagination\Listener;

use DMP\PaginatorBundle\Pagination\PaginatedCollection;
...
final class PaginationListener implements EventSubscriberInterface
{
    ...
    private function getPages(PaginatedCollection $paginator): array
    {
        ...
        $last = $paginator->getTotalPages() ?: 1;
